...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "search.agentsPlaceholder": "Search agents & skills…",
    ...
    // agents mode
    "agents.title": "Agents",
    "agents.subtitle": "Manage the AI-config files of your project's linked repository.",
    "agents.pickProjectTitle": "Manage agents & skills",
    "agents.pickProject": "Select a project from the sidebar to manage its instructions, agents, and skills.",
    "agents.noProjects": "No projects yet — create one in Chat mode first.",
    "agents.sidebarProjects": "Projects",
    "agents.noLinkedDir": "No linked directory",
    "agents.noItems": "No agents or skills",
    "agents.setupTitle": "Link a repository",
    "agents.setupHint": "Point this project at a local repository to manage its AI-config files (CLAUDE.md, AGENTS.md, agents and skills).",
    "agents.setupSave": "Link directory",
    "agents.setupSaving": "Linking…",
    "agents.directoryMissing": "The directory “{dir}” does not exist on disk.",
    "agents.instructions": "Instructions",
    "agents.agents": "Agents",
    "agents.skills": "Skills",
    "agents.emptyAgents": "No agents yet.",
    "agents.emptySkills": "No skills yet.",
    "agents.createFile": "Create {name}",
    "agents.newAgent": "New agent",
    "agents.newSkill": "New skill",
    "agents.newAgentTitle": "New agent",
    "agents.newSkillTitle": "New skill",
    "agents.nameLabel": "Name",
    "agents.agentNamePlaceholder": "code-reviewer",
    "agents.skillNamePlaceholder": "pdf-tools",
    "agents.sync": "Sync",
    "agents.synced": "Synced",
    "agents.syncTitle": "Sync instructions",
    "agents.syncOneDesc": "“{link}” will become a symlink to “{target}”, so Claude and Codex share one instructions file.",
    "agents.syncChooseTitle": "Sync instructions",
    "agents.syncChooseDesc": "Both files exist. Choose which one is the source of truth — the other becomes a symlink to it.",
    "agents.syncUse": "Use {name}",
    "agents.symlink": "Symlink",
    "agents.selectFile": "Select a file",
    "agents.selectFileHint": "Pick a file on the left to view and edit it.",
    "agents.deleteTitle": "Delete file",
    "agents.deleteDesc": "“{path}” will be permanently deleted.",
    "agents.saved": "Saved",
  },
  fr: {
    ...
    "search.agentsPlaceholder": "Rechercher des agents et skills…",
    ...
    // mode agents
    "agents.title": "Agents",
    "agents.subtitle": "Gérez les fichiers de configuration IA du dépôt lié à votre projet.",
    "agents.pickProjectTitle": "Gérer les agents et skills",
    "agents.pickProject": "Sélectionnez un projet dans le panneau pour gérer ses instructions, agents et skills.",
    "agents.noProjects": "Aucun projet — créez-en un d’abord en mode Discussion.",
    "agents.sidebarProjects": "Projets",
    "agents.noLinkedDir": "Aucun répertoire lié",
    "agents.noItems": "Aucun agent ni skill",
    "agents.setupTitle": "Lier un dépôt",
    "agents.setupHint": "Associez ce projet à un dépôt local pour gérer ses fichiers de configuration IA (CLAUDE.md, AGENTS.md, agents et skills).",
    "agents.setupSave": "Lier le répertoire",
    "agents.setupSaving": "Liaison…",
    "agents.directoryMissing": "Le répertoire « {dir} » n’existe pas sur le disque.",
    "agents.instructions": "Instructions",
    "agents.agents": "Agents",
    "agents.skills": "Skills",
    "agents.emptyAgents": "Aucun agent pour l’instant.",
    "agents.emptySkills": "Aucun skill pour l’instant.",
    "agents.createFile": "Créer {name}",
    "agents.newAgent": "Nouvel agent",
    "agents.newSkill": "Nouveau skill",
    "agents.newAgentTitle": "Nouvel agent",
    "agents.newSkillTitle": "Nouveau skill",
    "agents.nameLabel": "Nom",
    "agents.agentNamePlaceholder": "code-reviewer",
    "agents.skillNamePlaceholder": "pdf-tools",
    "agents.sync": "Synchroniser",
    "agents.synced": "Synchronisé",
    "agents.syncTitle": "Synchroniser les instructions",
    "agents.syncOneDesc": "« {link} » deviendra un lien symbolique vers « {target} », afin que Claude et Codex partagent un seul fichier d’instructions.",
    "agents.syncChooseTitle": "Synchroniser les instructions",
    "agents.syncChooseDesc": "Les deux fichiers existent. Choisissez lequel fait référence — l’autre deviendra un lien symbolique vers celui-ci.",
    "agents.syncUse": "Utiliser {name}",
    "agents.symlink": "Lien symbolique",
    "agents.selectFile": "Sélectionnez un fichier",
    "agents.selectFileHint": "Choisissez un fichier à gauche pour l’afficher et le modifier.",
    "agents.deleteTitle": "Supprimer le fichier",
    "agents.deleteDesc": "« {path} » sera définitivement supprimé.",
    "agents.saved": "Enregistré",
  },
};
