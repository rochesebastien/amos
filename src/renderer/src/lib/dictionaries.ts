...
export const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "composer.switchProject": "Work in another project",
    "composer.switchBranch": "Switch branch",
    "composer.noBranches": "No branch found",
    "composer.add": "Start something here",
    "composer.modelLabel": "Model",
    "composer.modelDefault": "The CLI's default",
  ...
  fr: {
    ...
    "composer.local": "Local",
    "composer.switchProject": "Travailler dans un autre projet",
    "composer.switchBranch": "Changer de branche",
    "composer.noBranches": "Aucune branche trouvée",
    "composer.add": "Démarrer quelque chose ici",
    "composer.modelLabel": "Modèle",
    "composer.modelDefault": "Défaut du CLI",
    "composer.effortLabel": "Réflexion",
    "composer.effort.low": "Faible",
    "composer.effort.medium": "Moyen",
    "composer.effort.high": "Élevé",
    "chat.disclaimer":
