...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "cap.readOnly": "Read-only for now — editing arrives in the next iteration.",

    // agent detail
    "agent.frontmatter": "Frontmatter",
    "agent.field": "Field",
    "agent.value": "Value",
    "agent.noFrontmatter": "This agent declares no frontmatter.",
    "agent.instructions": "Instructions",
    "agent.noBody": "This agent has no instructions.",
    "agent.model": "Model",
    "agent.tools": "Tools",
  ...
  fr: {
    ...
    "cap.readOnly": "En lecture seule pour l’instant — l’édition arrive à la prochaine itération.",

    "agent.frontmatter": "En-tête (frontmatter)",
    "agent.field": "Champ",
    "agent.value": "Valeur",
    "agent.noFrontmatter": "Cet agent ne déclare aucun en-tête.",
    "agent.instructions": "Instructions",
    "agent.noBody": "Cet agent n’a aucune instruction.",
    "agent.model": "Modèle",
    "agent.tools": "Outils",
    ...
    "mcp.declaredIn": "Déclaré dans",
    "mcp.raw": "Entrée brute",
    "mcp.empty": "—",
